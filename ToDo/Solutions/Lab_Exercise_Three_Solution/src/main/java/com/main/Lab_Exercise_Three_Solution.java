...
////@ComponentScan({"com.main.service", "com.main.controllers", "com.main.validation"})
//@ComponentScan({"com.main.service", "com.main.controllers"})
//@EntityScan("com.main.model")
//@EnableJpaRepositories("com.main.repository")
public class Lab_Exercise_Three_Solution implements CommandLineRunner {

    @Autowired
    private AuthorRepository authorRepo;

    public static void main(String[] args) {
        SpringApplication.run(Lab_Exercise_Three_Solution.class, args);
    }
